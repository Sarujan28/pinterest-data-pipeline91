    ...
    while True:
        ...
        with engine.connect() as connection:
            ...
            for row in pin_selected_row:
                ...
                invoke_url = 'https://jk0h28i633.execute-api.us-east-1.amazonaws.com/dev/topics/12e2eaf6ffd1.pin'
                payload = json.dumps({
                    'records': [
                        {
            ...
            for row in geo_selected_row:
                ...
                invoke_url = 'https://jk0h28i633.execute-api.us-east-1.amazonaws.com/dev/topics/12e2eaf6ffd1.geo'
                payload = json.dumps({
                    'records': [
                        {
            ...
            for row in user_selected_row:
                ...
                invoke_url = 'https://jk0h28i633.execute-api.us-east-1.amazonaws.com/dev/topics/12e2eaf6ffd1.user'
                payload = json.dumps({
                    'records': [
                        {
